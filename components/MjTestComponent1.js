...
*/
export default class MjTestComponent1 extends BodyComponent {
    ...
    getStyles() {
        return {
            wrapperDiv: {
                color: this.getAttribute('text-color'), // this.getAttribute(attrName) is the recommended way to access the attributes our component received in the mjml
    ...
    */
    render() {
      ...
      <p ${this.htmlAttributes({
        ...
        <span>This Is My Test Component #1</span>
        <span
          ${this.htmlAttributes({
